...
allImage.forEach(img => imgObserver.observe(img))
...
// Delete Elements
const cookieBtn = document.querySelector('.btn--close-cookie').addEventListener('click', () => {
    message.remove()
})
...
//     alert('You enter and read the heading !')
// }
